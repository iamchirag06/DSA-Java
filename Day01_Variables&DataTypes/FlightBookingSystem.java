...
class Flight {
    ...
    public Flight(String flightNumber, String origin, String destination, Date departureTime, int totalSeats) {
        ...
        Arrays.fill(this.availableSeats, true); // All seats are initially available
    }
    ...
    public boolean bookSeat(int seatNumber) {
        if (seatNumber > 0 && seatNumber <= totalSeats && availableSeats[seatNumber - 1]) {
...
public class FlightBookingSystem {
    ...
    public static void main(String[] args) {
        ...
        if (selectedFlight.bookSeat(seatChoice)) {
            ...
            double paymentAmount = 150.00; // Example price
